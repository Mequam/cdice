...
cdice 1+2d6
this command will roll a 6 sided dice, add 1 to it and return the result

cdice can even use parenthasis! do you want to roll a 1d20 amount of 1d20s, cdice has you coverd!
...
the dashes can be chained for interesting behavior, for example the following command will roll 3d6 twice 6 times
cdice -6 -2 3d6
